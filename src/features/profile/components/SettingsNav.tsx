import { User, Palette, Bell, SlidersHorizontal, Database, Info, ChevronRight } from "lucide-react";
import { cn } from "@/lib/utils/cn";

export type SettingsSection = "profile" | "appearance" | "notifications" | "preferences" | "data" | "about";
